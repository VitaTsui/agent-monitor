...
export const SelectCard: React.FC<{
  ...
  /**
   * 多选的「Submit」在终端选择卡里的按键编号：N 个选项占 1..N，其后「其它/自定义」
   * 占 N+1，Submit 是 N+2。多选要先逐个勾选、最后落在它上面才提交。
   *
   ...
   * from_select 关掉了。
   *
   * 多发的这一下不是无害的：3 个选项时它是「5」，终端根本没有 5 号键，整条作答就此
   * 卡住 —— 卡片停在原地，点了等于没点。（08-17 抓到：钉钉回「4」1 秒即落定，网页
   * 点同一张卡发出「15」，53 秒毫无动静，最后是人跑去终端手动选的。）
   */
